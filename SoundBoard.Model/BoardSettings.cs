...
namespace SoundBoard.Model
{
    ...
    public class BoardSettings
    {
        ...
        /// </summary>
        public int AudioPassthroughLatency { get; set; } = DefaultAudioPassthroughLatency;

        /// <summary>
        /// Number of rows to use for new pages.
        /// </summary>
        public int NewPageDefaultRows { get; set; } = DefaultNewPageRows;

        /// <summary>
        /// Number of columns to use for new pages.
        /// </summary>
        public int NewPageDefaultColumns { get; set; } = DefaultNewPageColumns;
