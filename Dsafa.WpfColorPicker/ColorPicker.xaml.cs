...
namespace Dsafa.WpfColorPicker
{
    ...
    public partial class ColorPicker : UserControl
    {
        ...
        /// <summary>
        /// Removes the transparency (alpha) slider from the picker. This is a SoundBoard addition
        /// (see NOTICE.md); the numeric alpha input is left in place, as in the original fork.
        /// </summary>
        public void HideTransparencyPicker()
        {
            DockPanel.Children.Remove(TransparencyPicker);
        }
